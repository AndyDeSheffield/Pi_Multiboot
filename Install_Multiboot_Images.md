...
##  Conclusion
All the 64 bit Raspian images and the 64 bit Ubuntu images (<v26)K that I've tested booted using this technique. All 4 processors are present and there is working sound but that's all that I've tested.
#### Footnote
